...
class home(TemplateView):
    ...
    def get(selt, request):
        ...
        return render(request, selt.template_name, {'rooms': rooms, 'about': about, 'blog': blog,
                                                    'testimony': testimony, 'año':año, 'mes':mes, 'dia':dia})
...
class publicaciones(TemplateView):
    template_name = 'hotel/publicaciones.html'
    def get(selt, request):
        room = Room.objects.all()
        return render(request, selt.template_name,{"room":room})    

class publicar(TemplateView):
    template_name = 'hotel/Publicar.html'
    def get(selt, request):
